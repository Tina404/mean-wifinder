...
if (process.env.NODE_ENV === 'production') {
  apiOptions.server = 'https://tinas-mean-wifinder.herokuapp.com/';
}
  ...
  res.render('location-info',
    {
      ...
      sidebar: {
        context: 'is on Wifinder because it has accessible wifi and space to sit down with your laptop and get some work done.',
